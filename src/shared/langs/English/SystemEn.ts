...
export const SystemEn: LanguageTranslation = {
  title: "GJZ26 - Web Portfolio", // The text that is displayed in the browser tab
  language: "English", // How the language should be displayed in the header bar!
  theme: "Theme",
  about: "About Me",
  ...
  skills: "Skills",
  download_cv_in: "Download resume in"
};
